...
int DijetQA::Init(PHCompositeNode* /*topNode*/)
{
  ...
  h_dphi = new TH1F(std::format("h_{}_dphi", smallModuleName).c_str(), std::format("#Delta #varphi for identified jet pairs for {}; #Delta #varphi; N_{{pairs}}", m_recoJetName).c_str(), 32, 0, M_PI);
  ...
  h_dphi_pt = new TH2F(std::format("h_{}_dphi_pt", smallModuleName).c_str(), std::format("|#Delta #varphi| of dijet pair as a function of leading jet p_{{T}} for {}; p_{{T}}^{{leading}} [GeV/c]; |#Delta #varphi|; N_{{pairs}}", m_recoJetName).c_str(), 70, -0.5, 69.5, 32, 0, M_PI);
  h_dphi_Ajj = new TH2F(std::format("h_{}_dphi_Ajj", smallModuleName).c_str(), std::format("A_{{jj}} of dijet pair as a function of |#Delta #varphi| for {}; |#Delta #varphi|; A_{{jj}}; N_{{pairs}}", m_recoJetName).c_str(), 32, 0, M_PI, 100, -0.005, 0.995);
  ...
  h_dphi_l = new TH1F(std::format("h_{}_dphi_l", smallModuleName).c_str(), std::format("#Delta #varphi for leading jet pairs for {}; #Delta #varphi; N_{{pairs}}", m_recoJetName).c_str(), 32, 0, M_PI);
  ...
  h_dphi_pt_l = new TH2F(std::format("h_{}_dphi_pt_l", smallModuleName).c_str(), std::format("|#Delta #varphi| of event leading dijet pair as a function of leading jet p_{{T}} for {}; p_{{T}}^{{leading}} [GeV/c]; |#Delta #varphi|; N_{{pairs}}", m_recoJetName).c_str(), 70, -0.5, 69.5, 32, 0, M_PI);
